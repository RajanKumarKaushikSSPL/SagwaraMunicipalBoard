...
public class TC014_VerifyUpdatePropertyDetailsTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC014_VerifyUpdatePropertyDetailsTest*****");
		    ...
		    dp.clickUpdatePropertyDetailsSubMenu();
		    logger.info("Clicked on update property details submenu..");
			...
			logger.info("*****Finished TC014_VerifyUpdatePropertyDetailsTest*****");
	}

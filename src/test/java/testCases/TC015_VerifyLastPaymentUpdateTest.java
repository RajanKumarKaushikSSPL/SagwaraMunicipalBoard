...
public class TC015_VerifyLastPaymentUpdateTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC015_VerifyLastPaymentUpdateTest*****");
		    ...
		    dp.clickLastPaymentUpdateSubMenu();
		    logger.info("Clicked on last payment update submenu..");
			...
			logger.info("*****Finished TC015_VerifyLastPaymentUpdateTest*****");
	}

...
public class TC018_VerifyAdjustmentTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC018_VerifyAdjustmentTest*****");
		    ...
		    dp.clickAdjustmentSubMenu();
		    logger.info("Clicked on adjustment submenu..");
			...
			logger.info("*****Finished TC018_VerifyAdjustmentTest*****");
	}

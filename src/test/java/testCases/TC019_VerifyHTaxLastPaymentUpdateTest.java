...
public class TC019_VerifyHTaxLastPaymentUpdateTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC019_VerifyHTaxLastPaymentUpdateTest*****");
		    ...
		    dp.clickHTaxLastPaymentUpdateSubMenu();
		    logger.info("Clicked on HTax last payment update submenu..");
			...
			logger.info("*****Finished TC019_VerifyHTaxLastPaymentUpdateTest*****");
	}

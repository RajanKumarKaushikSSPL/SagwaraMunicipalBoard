...
public class TC065_VerifyUDTaxReportMenuTest extends BaseClass {
	
	@Test(groups={"Smoke"})
	public void verify_UDTaxReportMenuExists() {
		
	logger.info("*****Starting TC065_VerifyUDTaxReportMenuTest*****");
	...
	try {
	    ...
	    logger.info("*****Finished TC065_VerifyUDTaxReportMenuTest*****");
	}

...
public class TC017_VerifyWardUpdateTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC017_VerifyWardUpdateTest*****");
		    ...
		    dp.clickWardUpdateSubMenu();
		    logger.info("Clicked on ward update submenu..");
			...
			logger.info("*****Finished TC017_VerifyWardUpdateTest*****");
	}

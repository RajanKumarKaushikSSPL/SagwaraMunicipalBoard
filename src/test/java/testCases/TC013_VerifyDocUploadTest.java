...
public class TC013_VerifyDocUploadTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC013_VerifyDocUploadTest*****");
		    ...
		    dp.clickDocUploadSubMenu();
		    logger.info("Clicked on doc upload submenu..");
			...
			logger.info("*****Finished TC013_VerifyDocUploadTest*****");
	}

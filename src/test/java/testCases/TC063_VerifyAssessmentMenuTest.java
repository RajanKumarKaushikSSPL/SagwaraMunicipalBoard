...
public class TC063_VerifyAssessmentMenuTest extends BaseClass {
	
	@Test(groups={"Smoke"})
	public void verify_AssessmentMenuExists() {
		
	logger.info("*****Starting TC063_VerifyAssessmentMenuTest*****");
	...
	try {
	    ...
	    logger.info("*****Finished TC063_VerifyAssessmentMenuTest*****");
	}

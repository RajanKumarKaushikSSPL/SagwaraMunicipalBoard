...
public class TC016_VerifyUpdateOwnerDetailsTest extends BaseClass {
	
	@Test(groups={"Sanity","Master","Regression"})
	public void verify_PropertyListPageExists() throws InterruptedException{
		
			logger.info("*****Starting TC016_VerifyUpdateOwnerDetailsTest*****");
		    ...
		    dp.clickUpdateOwnerDetailsSubMenu();
		    logger.info("Clicked on update owner details submenu..");
			...
			logger.info("*****Finished TC016_VerifyUpdateOwnerDetailsTest*****");
	}
